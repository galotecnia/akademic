...
class AkademicEvaluacionTutorTest(AkademicBaseTest):
    fixtures = ["evaluacion"]

    def setUp(self):
        self.profesor = Client ()
        self.WRITE = False
        self.url = "%s/akademic/evaluacionTutor/True/" % settings.SITE_LOCATION
    ...
    def test_AccesoTutor(self):
        """
            Controla que un tutor pueda, efectivamente disponer de la
            opción de evaluar a los alumnos de su tutoria.
        """
    ...
    def test_AsignaturasProfesor1(self):
        ...
        self.assertContains(response, "Asignat2 - 11")
        self.assertNotContains(response, "Asignat1 - 12B")
        self.assertNotContains(response, "Asignat2 - 12B")
    ...
    def test_AsignaturasProfesor2(self):
        ...
        response = self.profesor.get(self.url)
        self.assertContains(response, "Asignat1 - 12B")
        self.assertContains(response, "Asignat2 - 12B")
        self.assertNotContains(response, "Asignat1 - 11")
